...
Tensor grid_sampler_batch_2d_cpu(const at::Tensor& input, const at::Tensor& grid, const at::Tensor& batch_idx,
                           int64_t interpolation_mode, int64_t padding_mode,
                           bool align_corners);
std::tuple<at::Tensor, at::Tensor> grid_sampler_batch_2d_backward_cpu(const at::Tensor& grad_output, const at::Tensor& input, const at::Tensor& grid, const at::Tensor& batch_idx,
