...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=[
'data/synthtext-150k/syntext1/train_polygon.json',
            'data/mlt17/train_polygon.json',
                  'data/synthtext-150k/syntext2/train_polygon.json',
            'data/totaltext/totaltext_train.json'
                  ],
        img_prefix=[
'data/synthtext-150k/syntext1/images/',
            'data/mlt17/images',
            'data/synthtext-150k/syntext2/images/',
...
# optimizer
optimizer = dict(type='SGD', lr=2e-3, momentum=0.90, weight_decay=5e-4)
optimizer_config = dict(grad_clip=None)
lr_config = dict(
    policy='step', step=[130000, 180000],by_epoch=False,
